...
public class UltrasonicLocalizer {
	...
	private void fallingEdgeRoutine() {
		  // TODO Auto-generated method stub
			...
			rotateTheRobot(false, 10, false);
			moveFromLeftWall = Math.floor(30.48 - (correctDx1/cos10 + correctDx2/cos10 + dx)/3 - 5);
			rotateTheRobot(true, 90, false);
			//detect the distance from right wall
			...
			rotateTheRobot(true, 10, false);
			moveFromBacktWall = Math.floor(30.48 - (correctDy1/cos10 + correctDy2/cos10 + dy)/3 - 5);
